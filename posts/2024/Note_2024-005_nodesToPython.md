...
for node in checkList:
	...
	nodeList.append(f'nodeList[{nodeCounter}] = createNode("{mc.nodeType(node)}", n="{node}", skipSelect = True)')
...
nodeList[0] = createNode("composeMatrix", n="cmx_noFlipOffset", skipSelect = True)
nodeList[1] = createNode("composeMatrix", n="cmx_testRotate", skipSelect = True)
nodeList[2] = createNode("multMatrix", n="multMatrix4", skipSelect = True)
nodeList[3] = createNode("joint", n="jFinger0", skipSelect = True)
nodeList[4] = createNode("joint", n="jRoot", skipSelect = True)
nodeList[5] = createNode("composeMatrix", n="composeMatrix6", skipSelect = True)
nodeList[6] = createNode("transform", n="locNoFlipPvEnd", skipSelect = True)
nodeList[7] = createNode("pickMatrix", n="pickMatrix1", skipSelect = True)
nodeList[8] = createNode("transform", n="locNoFlipPvBase", skipSelect = True)
nodeList[9] = createNode("multMatrix", n="multMatrix3", skipSelect = True)
nodeList[10] = createNode("joint", n="jFinger1", skipSelect = True)
nodeList[11] = createNode("joint", n="jFinger3", skipSelect = True)
nodeList[12] = createNode("joint", n="jFinger2", skipSelect = True)
nodeList[13] = createNode("joint", n="jFingerIKDriver0", skipSelect = True)
nodeList[14] = createNode("joint", n="jFingerIKDriver1", skipSelect = True)
nodeList[15] = createNode("composeMatrix", n="composeMatrix3", skipSelect = True)
nodeList[16] = createNode("distanceBetween", n="dbt_hFloor2", skipSelect = True)
nodeList[17] = createNode("joint", n="jFingerIKDriver2", skipSelect = True)
nodeList[18] = createNode("composeMatrix", n="composeMatrix7", skipSelect = True)
nodeList[19] = createNode("joint", n="jFingerIKDriver3", skipSelect = True)
nodeList[20] = createNode("distanceBetween", n="dbt_hFloor1", skipSelect = True)
nodeList[21] = createNode("network", n="netInvLerp0", skipSelect = True)
nodeList[22] = createNode("addDoubleLinear", n="adl_finger0_MD", skipSelect = True)
nodeList[23] = createNode("ikHandle", n="ikHandle5", skipSelect = True)
nodeList[24] = createNode("addDoubleLinear", n="adl_finger0_PMD", skipSelect = True)
nodeList[25] = createNode("multMatrix", n="multMatrix1", skipSelect = True)
nodeList[26] = createNode("multMatrix", n="multMatrix2", skipSelect = True)
nodeList[27] = createNode("ikHandle", n="ikHandle6", skipSelect = True)
nodeList[28] = createNode("network", n="netLerp0", skipSelect = True)
nodeList[29] = createNode("transform", n="loc_fingerIkTarget", skipSelect = True)
nodeList[30] = createNode("distanceBetween", n="distanceBetween2", skipSelect = True)
nodeList[31] = createNode("aimMatrix", n="aimMatrix1", skipSelect = True)
nodeList[32] = createNode("composeMatrix", n="cmx_tzOne", skipSelect = True)
nodeList[33] = createNode("joint", n="jFingerIkBase2", skipSelect = True)
nodeList[34] = createNode("joint", n="jFingerIkBase1", skipSelect = True)
